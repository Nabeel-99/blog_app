        ...
        <div className=" overflow-hidden relative  ">
          <div className="absolute max-sm:hidden -top-24 left-0">
            <img
              src={"/mark.svg"}
              alt="Spirals"
              className="w-full -z-10 opacity-30 "
            />
          </div>
          ...
          <div className="2xl:container 2xl:w-full 2xl:mx-auto lg:px-20 p-4 lg:p-26  text-white flex flex-col lg:flex-row gap-10 lg:justify-between">
            <BlurIn>
